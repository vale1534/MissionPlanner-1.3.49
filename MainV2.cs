...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        //INICIO - VICTOR - Criação do botão para conectar com o coordenador de Missões
       
        int click = 0; //variavel criada para definir se o clique é de conexão ou desconexão

        public void button1_Click(object sender, EventArgs e)
        {
            Coord_CON coordenador = new Coord_CON();

            //Decidindo se o clique é para conectar ou desconectar do coordenador
            if (click == 1)
            {
                coordenador.Handle_Disconnection();
                button1.Text = "Conectar Coordenador";
                coordenador.IP = "";
                coordenador.PORT = 0;
            ...
            {
                Con_Coord con = new Con_Coord();
                con.ShowDialog(); //Abre form criada para digitar IP e porta do socket associado ao coordenador
                coordenador.IP = con.IpAddress;
                coordenador.PORT= Convert.ToInt32(con.Port);
                coordenador.Handle_Connection(coordenador.IP, coordenador.PORT);
                button1.Text = "Desconectar Coordenador";
                click = 1;
